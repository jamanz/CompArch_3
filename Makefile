...
target:
	    ...
	    $(CC) -x assembler-with-cpp -c -O0 -g3 -mcpu=$(CPU_CC) -Wall func.S -o func.o		
	   $(CC) start.o func.o -mcpu=$(CPU_CC)  -Wall --specs=nosys.specs -nostdlib -lgcc -T./lscript.ld -o $(TARGET).elf
...
clean:
	    ...
	    -rm *.bin
flash:
	st-flasg write $(TARGET).bin 0x08000000
